  ...
  return (
    <section className={styles.section} id="game">
      <div className={styles.header}>
        <h2>Об игре</h2>
        <p>
          Трансформационная игра проходит <b>вживую</b> —
          это возможность встретиться с собой в бережном пространстве, 
          увидеть новые смыслы и превратить инсайты в шаги, которые реально сделать.
          <br /><br />
