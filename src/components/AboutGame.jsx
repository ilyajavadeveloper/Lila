  ...
  return (
    <section className={`${styles.section} page`} id="game">
      ...
      <div className={styles.cards}>
        {[
          ["🧭","Ясность","Сформулируем настоящий запрос и определим, что действительно важно именно сейчас."],
          ["💡","Инсайты","Найдём ключевые смыслы и новые перспективы — без давления и ожидания «правильных ответов»."],
          ["🗺️","План действий","Превратим открытия в реальные шаги с понятными сроками и поддержкой."],
          ["🫶","Атмосфера","Бережное пространство, где можно быть собой и говорить о важном открыто."],
          ["🎲","Игровой процесс","Поле, карты, вопросы и метафоры помогают глубже и мягче дойти до сути."],
          ["🌿","Экологичность","Уважение к твоему темпу и ресурсам. Никакой «магии результата» — только практика."]
        ].map(([ico, title, text]) => (
